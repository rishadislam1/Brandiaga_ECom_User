    ...
    <div className="hidden md:flex flex-col w-full">
      ...
      <div className="bg-[#232f3e] flex items-center justify-between w-full gap-4 py-2 px-4">
        ...
        <div className="flex items-center gap-4 text-white">
          ...
          <Link
            to="/cart"
            className="flex items-end hover:text-brandiaga-yellow-400">
      ...
      <div className="bg-[#232f3e] border-t border-gray-700 px-4 py-2">
        <nav className="flex items-center gap-6 text-white">
          <Menubar className="bg-transparent border-none p-0">
            <MenubarMenu>
              ...
              <MenubarContent className="w-64 bg-white text-black border border-gray-200">
                <div className="py-2">
                  {/* Trending Section */}
                  <div className="px-3 py-1.5 font-bold bg-gray-100">
                    Trending
                  </div>
                  <MenubarItem>
                    <Link to="/trending/best-sellers" className="w-full">
                      Best Sellers
                    </Link>
                  </MenubarItem>
                  <MenubarItem>
                    <Link to="/trending/new-releases" className="w-full">
                      New Releases
                    </Link>
                  </MenubarItem>
                  <MenubarSeparator />
                  ...
                  <MenubarItem>
                    <Link to="/electronics" className="w-full">
                      Electronics
                    </Link>
                  </MenubarItem>
                  <MenubarItem>
                    <Link to="/computers" className="w-full">
                      Computers
                    </Link>
                  </MenubarItem>
                  <MenubarItem>
                    <Link to="/smart-home" className="w-full">
                      Smart Home
                    </Link>
                  </MenubarItem>
                  <MenubarItem>
                    <Link to="/arts-crafts" className="w-full">
                      Arts & Crafts
                    </Link>
                  </MenubarItem>
                  <MenubarSeparator />
                  ...
                  <MenubarItem>
                    <Link to="/shop-by-interest" className="w-full">
                      Shop By Interest
                    </Link>
                  </MenubarItem>
                  <MenubarItem>
                    <Link to="/brandiaga-live" className="w-full">
                      Brandiaga Live
                    </Link>
                  </MenubarItem>
                  <MenubarItem>
                    <Link to="/international-shopping" className="w-full">
                  ...
                  <MenubarItem>
                    <Link to="/customer-service" className="w-full">
                      Customer Service
                    </Link>
                  </MenubarItem>
                  <MenubarItem>
                  ...
                  <MenubarItem>
                    <Link to="/language" className="w-full">
                      English
                    </Link>
                  </MenubarItem>
                </div>
          ...
          <Link to="/contact-us" className="hover:text-brandiaga-yellow-400">
            Contact Us
          </Link>
          <Link to="/faq" className="hover:text-brandiaga-yellow-400">
            FAQ
          </Link>
          <Link to="/track-order" className="hover:text-brandiaga-yellow-400">
           Track Order
          </Link>
          <Link to="/signup" className="hover:text-brandiaga-yellow-400">
            Register
          </Link>
