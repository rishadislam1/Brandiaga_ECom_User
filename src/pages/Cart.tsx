...
import { updateCartItem, removeFromCart, addToCart } from '@/redux/Slicers/CartSlice';
...
const Cart = () => {
  ...
  const handleProceedToCheckout = () => {
    navigate("/checkout", { state: { cartItems, subtotal, shipping, tax, total, deliveryOption } });
  };
      ...
      <div className="min-h-screen bg-gray-100 py-6">
        <div className="container mx-auto px-4">
          ...
          <div className="flex items-center text-sm mb-4 overflow-x-auto whitespace-nowrap">
            <Link to="/" className="text-gray-500 hover:text-brandiaga-yellow-600">
              Home
            </Link>
          ...
          {cartItems.length === 0 ? (
              <div className="bg-white rounded-lg shadow-md p-4 sm:p-8 text-center max-w-2xl mx-auto">
                ...
                <h2 className="text-xl sm:text-2xl font-medium mb-2">Your Amazon Cart is empty</h2>
                ...
                <Button className="bg-brandiaga-yellow-400 hover:bg-brandiaga-yellow-500 text-gray-900" asChild>
                ...
                <div className="mt-8 pt-8 border-t border-gray-200">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                    {products.slice(0, 4).map((product) => (
                        <div key={product.productId} className="bg-gray-50 p-2 rounded">
                          ...
                          <div className="text-xs mt-2 text-left">
                            ...
                            <p className="font-bold mt-1">${(product.discountPrice || product.price).toFixed(2)}</p>
                          </div>
                        </div>
                    ))}
                  </div>
                ...
                <div className="lg:col-span-2">
                  <div className="bg-white rounded-lg shadow-md overflow-hidden">
                    ...
                    <ul className="divide-y divide-gray-200">
                      {cartItems.map((item) => (
                          <li key={`${item.productId}-${item.color}`} className="p-4 sm:p-6">
                                  ...
                                  <div>
                                    ...
                                    {item.isPrime && (
                                        <div className="flex items-center mt-1">
                                          <span className="bg-blue-100 text-blue-800 text-xs px-1 rounded mr-2">Prime</span>
                                          <span className="text-xs text-gray-600">FREE delivery by tomorrow</span>
                                        </div>
                                    )}
                    ...
                    <div className="p-4 sm:p-6 border-t border-gray-200 text-right">
                      <div className="text-lg font-bold">
                        ...
                        <span className="text-brandiaga-yellow-800">${subtotal.toFixed(2)}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-lg shadow-md overflow-hidden mt-6">
                    <div className="p-4 sm:p-6 border-b border-gray-200">
                      <h2 className="text-xl font-semibold">Saved for Later ({savedForLater.length} items)</h2>
                    </div>
                    ...
                    {isLoading ? (
                        ...
                        <>
                          ...
                          <div className="text-sm mb-4">
                            <p>
                              Shipping: <span className="text-brandiaga-yellow-800">${shipping.toFixed(2)}</span>
                            </p>
                            <p>
                              Tax: <span className="text-brandiaga-yellow-800">${tax.toFixed(2)}</span>
                            </p>
                            <p className="font-bold mt-2">
                              Total: <span className="text-brandiaga-yellow-800">${total.toFixed(2)}</span>
                            </p>
                          </div>
                          ...
                          <div className="border-t pt-4 mt-2">
                            <h3 className="font-medium text-sm mb-2">Delivery options:</h3>
                            <div className="space-y-2">
                              ...
                              <div className="flex items-start">
                                ...
                                <label htmlFor="express" className="text-sm">
                                  <span className="font-medium">Express Delivery (+$10.00)</span>
                    ...
                    {relatedProducts.length === 0 ? (
                        ...
                        <div className="space-y-3">
                          {relatedProducts.map((product) => (
                              <div key={`${product.productId}-${product.color}`} className="flex gap-3 items-center">
