...
import { Loader, Truck, Package, CheckCircle, MapPin, Calendar } from "lucide-react";
import { Separator } from "@/components/ui/separator";

// Mock order tracking data
const mockOrderTracking = {
  orderNumber: "B-12345678",
  status: "In Transit",
  estimatedDelivery: "April 24, 2025",
  shippingAddress: "1234 Market St, San Francisco, CA 94103",
  carrier: "FedEx",
  trackingNumber: "FX123456789012",
  items: [
    { name: "Wireless Noise Cancelling Headphones", quantity: 1, status: "Shipped" },
    { name: "Smart Water Bottle with Temperature Display", quantity: 2, status: "Shipped" }
  ],
  trackingHistory: [
    { 
      date: "April 21, 2025", 
...
const TrackOrder = () => {
  ...
  const handleSearch = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      if (orderNumber === "B-12345678" || orderNumber === "12345678") {
        ...
        toast({
          ...
          description: "We couldn't find an order with that number and email combination. Please check your information and try again.",
          variant: "destructive",
        });
      }
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
          <form onSubmit={handleSearch}>
            ...
            <p className="text-sm text-gray-500 mt-2">
              For testing, use order number "B-12345678" with any valid email format.
            </p>
          </form>
        </div>
                    ...
                    <a 
                      ...
                      onClick={(e) => {
                        ...
                        toast({
                          ...
                          description: "This would open the carrier's tracking page in a real app.",
                        });
                      }}
                    >
              ...
              {trackingData.trackingHistory.map((event, index) => (
                <div key={index} className="relative mb-6 last:mb-0">
                  ...
                  <div className={`absolute left-0 top-1.5 w-5 h-5 rounded-full flex items-center justify-center ${
                    ...
                    {index === 0 && <CheckCircle className="h-5 w-5 text-white" />}
                  </div>
            ...
            <div className="flex justify-between flex-wrap gap-4">
              <Button 
                ...
                onClick={() => {
                  toast({
                    title: "Email sent",
                    description: "A copy of your tracking information has been sent to your email.",
                  });
                }}
              >
