    ...
    <div className="min-h-screen bg-white flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <Link to="/" className="flex justify-center">
          <span className="text-3xl font-bold tracking-tight text-brandiaga-yellow-600 animate-pulse">Brandiaga</span>
        </Link>
        <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">Create your account</h2>
        <p className="mt-2 text-center text-sm text-gray-600">
          Or{' '}
          <Link to="/signin" className="font-medium text-brandiaga-yellow-600 hover:text-brandiaga-yellow-500">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                <label htmlFor="terms" className="ml-2 block text-sm text-gray-900">
                  I agree to the{' '}
                  <Link to="/terms" className="text-brandiaga-yellow-600 hover:text-brandiaga-yellow-500">
                    Terms
                  </Link>{' '}
                  and{' '}
                  <Link to="/privacy-policy" className="text-brandiaga-yellow-600 hover:text-brandiaga-yellow-500">
                    Privacy Policy
                  </Link>
                </label>
              </div>
